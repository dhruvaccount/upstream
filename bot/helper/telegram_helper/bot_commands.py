...
class _BotCommands:
    def __init__(self):
        ...
        self.StatusCommand = [f'status{CMD_SUFFIX}', f's{CMD_SUFFIX}', 'statusall', 's']
        ...
        self.PingCommand = [f'ping{CMD_SUFFIX}', 'p', 'pingall']
        self.RestartCommand = [f'restart{CMD_SUFFIX}', 'restartall']
        self.StatsCommand = [f'stats{CMD_SUFFIX}', 'statsall', 'stats']
